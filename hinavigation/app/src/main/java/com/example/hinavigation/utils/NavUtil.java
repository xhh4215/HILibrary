package com.example.hinavigation.utils;
...
import com.example.hinavigation.R;
import com.example.hinavigation.manager.HiFragmentNavigator;
import com.example.hinavigation.model.BottomBar;
import com.example.hinavigation.model.Destination;
...
public class NavUtil {
    ...
    public static void builderNavGraph(FragmentActivity activity, FragmentManager fragmentManager,NavController controller, int containerId) {
        ...
        NavGraphNavigator navGraphNavigator = navigatorProvider.getNavigator(NavGraphNavigator.class);
        NavGraph navGraph = new NavGraph(navGraphNavigator);
        HiFragmentNavigator hiFragmentNavigator = new HiFragmentNavigator(activity,fragmentManager,containerId);
    ...
    public static void builderBottomBar(BottomNavigationView navigationView) {
        ...
        List<BottomBar.Tab> tabList = bottombar.tabs;
        Menu menu = navigationView.getMenu();
        for (BottomBar.Tab tab : tabList) {
